...
public class EnumGenerator {
    ...
    /**
     *Function: Convert camel case to uppercase underscore, and remove _ENUM 
     * e.g：SectionChargeEnum -> SECTION_CHARGE
     * @param str
     * @return
     */
    ...
    /**
     * CamelCase to underscore, the first character is an underscore
     * e.g: SectionChargeEnum -> _section_charge_enum
     * @param str
     * @return
     */
