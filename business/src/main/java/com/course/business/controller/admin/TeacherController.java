...
public class TeacherController {
    ...
    public static final String BUSINESS_NAME = "lecturer";
    ...
    public ResponseDto save(@RequestBody TeacherDto teacherDto) {
        ...
        ValidatorUtil.length(teacherDto.getImage(), "avatar", 1, 100);
        ValidatorUtil.length(teacherDto.getPosition(), "position", 1, 50);
        ValidatorUtil.length(teacherDto.getMotto(), "motto", 1, 50);
        ValidatorUtil.length(teacherDto.getIntro(), "description", 1, 500);
